...
namespace ProdCate.Migrations
{
    ...
    [Migration("20211216002901_FirstProdCateMigration")]
    partial class FirstProdCateMigration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProdCate.Models.Asso", b =>
                {
                    b.HasOne("ProdCate.Models.Cate", "Category")
                        .WithMany("Assignments")
                        .HasForeignKey("CateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProdCate.Models.Prod", "Product")
                        .WithMany("Assigner")
